...
public class groupe_verbe extends AppCompatActivity {

    private groupe_verbeQ mQuestionLibarary = new groupe_verbeQ();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_groupe_verbe );
    ...
    private void updateQuestion(){
        ...
        if (mQuestionNumber<mQuestionLibarary.getLength()){
            ...
            Toast.makeText(groupe_verbe.this, "It was the last question!", Toast.LENGTH_LONG).show();
            Intent intent = new Intent( groupe_verbe.this, Score_groupe.class );
