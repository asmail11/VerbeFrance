...
public class Score_groupe extends AppCompatActivity {
    private android.content.Intent chooser;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate( savedInstanceState );
        setContentView( R.layout.activity_score_groupe );
    ...
    public void ocCkickbtn(View view) {
        Intent intent = new Intent(Score_groupe.this, groupe_verbe.class );
