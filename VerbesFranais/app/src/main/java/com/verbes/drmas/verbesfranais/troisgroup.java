...
public class troisgroup extends AppCompatActivity {

    private troisgroup3 mQuestionLibarary = new troisgroup3();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_troisgroup );
    ...
    private void updateQuestion(){
        ...
        if (mQuestionNumber<mQuestionLibarary.getLength()){
            ...
            Toast.makeText(troisgroup.this, "It was the last question!", Toast.LENGTH_LONG).show();
            Intent intent = new Intent( troisgroup.this, Score3.class );
