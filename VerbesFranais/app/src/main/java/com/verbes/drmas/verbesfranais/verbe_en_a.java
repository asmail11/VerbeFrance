...
public class verbe_en_a extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_verbe_en_a );

        // Start ListView
        final ListView listView = (ListView)findViewById(R.id.ListView);
        strings = getResources().getStringArray( R.array.verbe_en_a);
        adapter = new ArrayAdapter<String>( verbe_en_a.this, R.layout.row_itme,R.id.textitem, strings);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(verbe_en_a.this, webhtml.class);
