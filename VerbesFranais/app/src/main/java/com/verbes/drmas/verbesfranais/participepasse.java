...
public class participepasse extends AppCompatActivity {

    private participepasseQ mQuestionLibarary = new participepasseQ();
    ...
    private void updateQuestion(){
        ...
        if (mQuestionNumber<mQuestionLibarary.getLength()){
            ...
            Toast.makeText(participepasse.this, "It was the last question!", Toast.LENGTH_LONG).show();
            Intent intent = new Intent( participepasse.this, Score_passe.class );
